...
//               id="time"
//               variant="outline"
//               className="flex-1 h-full flex-col gap-1"
//               onClick={() => setQueryType("time")}
...
//           </div>
//         </div>
//         <div className="col-span-7 flex flex-row gap-2 h-[100px]">{/* 추가적인 컴포넌트를 여기에 배치 */}</div>
//       </div>
